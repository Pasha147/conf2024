...
text.Ukr.main.articles[4] = (
  <>
    <p>
      ...
      <br />
      Академік НАН України, докторфізико-математичних наук, В.Л.Богданов, <br />
      Академік НАН України, доктортехнічних наук, В.М.Назаренко<br />
    </p>
    <p>Вчений секретар:<br /> 
    Кандидат фізико-математичних наук, Ю.О.Чорноіван<br />
    </p>
    <p>
